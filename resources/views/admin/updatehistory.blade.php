				    ...
				    <div class="row justify-content-center">						
					    <div class="col-12">
						    <div class="card" style="style">
								...
								<div class="card-body">
									<form class="form-horizontal" autocomplete="off"  action="{{ url('author/history/update') }}" method='POST' onsubmit=" return valid(); " enctype="multipart/form-data" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="records" id="records" class="form-control" placeholder="Records">{{ $data -> records }}</textarea>
